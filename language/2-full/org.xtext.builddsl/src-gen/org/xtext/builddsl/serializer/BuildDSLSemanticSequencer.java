package org.xtext.builddsl.serializer;
...
public class BuildDSLSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == BuildPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case BuildPackage.BUILD_FILE:
				if(context == grammarAccess.getBuildFileRule()) {
					sequence_BuildFile(context, (BuildFile) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName? importSection=XImportSection? declarations+=Declaration*)
	 */
	protected void sequence_BuildFile(EObject context, BuildFile semanticObject) {
